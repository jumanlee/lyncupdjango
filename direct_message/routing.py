...
websocket_urlpatterns = [
    re_path(r'ws/directmessage/(?P<conversation>\w+)/$', consumers.DirectMessageConsumer.as_asgi())
]
...
#application is defined in the asgi.py file, it knows this due to consumers.DirectMessageConsumer.as_asgi() defined in websocket_urlpatterns.
